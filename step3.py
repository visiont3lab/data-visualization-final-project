...
def fig_regioni(df,lista_regioni_to_plot):
    # lista_input è una lista che contiene i nomi delle regioni da plottare
    # plot_number numero di grafici da plottare All o 10
...
fig_reg = fig_regioni(df_regioni,[regione])
...
def update_fig_reg(dropdown_regioni_value):
    #print(checklist_value)
    fig_reg = fig_regioni(df_regioni, dropdown_regioni_value)
    return fig_reg
